    ...
    try:
        ...
        if result.data:
            ...
            return SearchFilter(
                ...
                min_rooms=row.get("min_rooms", DEFAULT_FILTER.get("min_rooms")),
                max_rooms=row.get("max_rooms", DEFAULT_FILTER.get("max_rooms")),
                default_radius=row.get("default_radius", DEFAULT_FILTER.get("default_radius", 10)),
